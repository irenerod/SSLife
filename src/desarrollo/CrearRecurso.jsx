  ...
  return (
    <Fragment>
      ...
      <div>
            ...
            <Button
                ...
                onClick={(e) => {
                    ...
                    if (validarFormulario()) {
                        crearRecurso(e);
                        handleRecursoCreado(); // Maneja la creación exitosa del recurso
                    }
                }}
            >
                Añadir producto
        ...
        {recursoCreado && <p style={{ color: 'green' }}>El recurso se creó correctamente.</p>}
        </form>
        )}
      </div>
    </Fragment>
