    ...
    <StyledContainer className="mt-5 pt-5">
      <Card className="shadow-sm">
        <Card.Body>
          <Row>
            <Col>
              <h1 className="main-heading">Política de Privacidad</h1>
              ...
              <h2 className="section-heading">2. Categoría de los datos recabados</h2>
              ...
              <h3 className="sub-heading">2.1. Datos recabados en caso de registro en SSLIFE:</h3>
              ...
              <h3 className="sub-heading">2.2. Datos recabados en el formulario newsletter:</h3>
              ...
              <h3 className="sub-heading">2.3. Responsabilidad al proporcionar datos personales:</h3>
              ...
              <h2 className="section-heading">3. Finalidad y legitimación (base jurídica) para el tratamiento de los datos personales.</h2>
              ...
              <h3 className="sub-heading">3.1. En caso de registro en SSLIFE:</h3>
              ...
              <h3 className="sub-heading">3.2. Segmentación con fines comerciales:</h3>
              ...
              <h3 className="sub-heading">3.3. Remitir comunicaciones comerciales:</h3>
              ...
              <h3 className="sub-heading">3.4. En caso de utilizar cualquier formulario de contacto o remitir un correo electrónico:</h3>
              ...
              <h2 className="section-heading">4. ¿Por cuánto tiempo se conservan los datos personales recabados?</h2>
              ...
              <h2 className="section-heading">5. Destinatarios</h2>
              ...
              <h2 className="section-heading">6. Derechos</h2>
              <div className="highlight">
              ...
              <h2 className="section-heading">7. Seguridad y actualización de tus datos personales</h2>
              ...
              <h2 className="section-heading yellow">8. Confidencialidad</h2>
